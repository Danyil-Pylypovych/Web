...
const courseList = ['Mathematics', 'Physics', 'English', 'Computer Science', 'Dancing', 'Chess', 'Biology', 'Chemistry',
...
const transformUserData = () => {
    const transformedData = randomUserMock.map(teacher => {
        ...
        return {
            ...
            favorite: false,
            courseList: courseList[Math.floor(Math.random() * courseList.length)],
            bg_color: '#9b9b9b',
            note: ''
        }
    });
...
export const randomUserTransformed = transformUserData(randomUserMock);

const mergeTwoArrayOfObjects = (firstArray, secondArray) => {
...
export const teacherListMerged = mergeTwoArrayOfObjects(randomUserTransformed, additionalUsers);
console.log(teacherListMerged);
